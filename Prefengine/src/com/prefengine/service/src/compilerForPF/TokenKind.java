 ...
 interface TokenGeneralKind
{
 ...
 /**
  *  represent for what is inside a parentheses,
  *  this class will be created in Scanner, and get more field in Parser.
  */
class Clause 
{	
	/** left-hand object of connective operator instance */
	 private BasicFunctionType lhand;
	 
	 /** right-hand object of connective operator instance */
	 private BasicFunctionType rhand;
	 
	 /** connective operator between the object inside a clause instance */
	 private ConnectiveOperator insideClause;
		 ...
		 */
	 public Clause(BasicFunctionType lhand,ConnectiveOperator insideClause,BasicFunctionType rhand)
	 {
		 this.lhand = lhand;
		 this.insideClause = insideClause;
		 this.rhand = rhand;
	 }
	 
		/**
		 * set up left-hand object of connective operator instance
		 * 
		 * @param lhand
		 * 			an object in OperationObject type
		 */
	 public void setLeftHand(BasicFunctionType lhand)
	 {
		 this.lhand = lhand;
	 }
	 
		/**
		 * set up right-hand object of connective operator instance
		 * 
		 * @param rhand
		 * 			an object in OperationObject type
		 */
	 public void setRightHand(BasicFunctionType rhand)
	 {
		 this.rhand = rhand;
	 }
		/**
		 * get left-hand object of connective operator instance
		 * 
		 * @return an object in OperationObject type
		 */
	 public BasicFunctionType getLeftHand()
	 {
		 return this.lhand;
	 }
		/**
		 * get right-hand object of connective operator instance
		 * 
		 * @return an object in OperationObject type
		 */
	 public BasicFunctionType getRightHand()
	 {
		 return this.rhand;
	 }	
	 
		/**
		 * set up connective operator between the object inside a clause instance
		 * 
		 * @param conectiveOperator
		 * 			an object in OperationObject type
		 */
	 public void setConnectiveOperatorInClause(ConnectiveOperator insideClause)
	 {
		 this.insideClause = insideClause;
	 }
		/**
		 * get connective operator between the object inside a clause instance
		 * 
		 * @return an conectiveOperator 
		 */
	 public ConnectiveOperator getConnectiveOperatorInClause()
	 {
		 return this.insideClause;
	 }
 ...
 enum ConnectiveOperator 
 {
	 ...
	 AND("&"),OR("|"),COMPROMISE("^"),CLAUSE("("),FURTHERFIX("?"),LONGPAUSE("#");
 ...
 */
enum CoreMeaning implements TokenGeneralKind
{
	...
	APRIL("april",Properties.NOUN,ServiceProperty.DURATION,WeightOriginalRange.POSITIVESLACK),
	...
	AUGUST("august",Properties.NOUN,ServiceProperty.DURATION,WeightOriginalRange.POSITIVESLACK),
...
//
	...
	COACH("coach",Properties.NOUN,ServiceProperty.SEATCLASS,WeightOriginalRange.STABLE),
...
//
	...
	FIRST("first",Properties.ADJV,ServiceProperty.SEATCLASS,WeightOriginalRange.POSITIVESUPREME),
...
//	
	...
	SECOND("second",Properties.ADJV,ServiceProperty.GENERALPROPERTY,WeightOriginalRange.POSITIVESLACK),
...
/////////////////
	...
	private float multipleweight;
	  ...
	  */
	private CoreMeaning(String image,Properties basicProperty,ServiceProperty basicFunctiontype,WeightOriginalRange weight)
	{
		this.image = image;
	  ...
	  */
	private CoreMeaning(String image,Properties basicProperty,ServiceProperty basicFunctiontype,float weight)
	{
		this.image = image;
		this.basicProperty=basicProperty;
		this.basicFunctiontype=basicFunctiontype;
...
public class TokenKind {
	...
	{
	CoreMeaning[] interactionOfCoremeaning = CoreMeaning.values();
	for(CoreMeaning coreMeaning :interactionOfCoremeaning)
	{
